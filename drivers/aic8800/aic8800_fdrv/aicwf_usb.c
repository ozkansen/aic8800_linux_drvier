...
static int aicwf_usb_chipmatch(struct aic_usb_dev *usb_dev, u16_l vid, u16_l pid){
	...
	if(pid == USB_PRODUCT_ID_AIC8801){
		...
		return 0;
	}else if(pid == USB_PRODUCT_ID_AIC8800DC || (vid == USB_VENDOR_ID_MERCUCYS && pid == USB_PRODUCT_ID_AIC8800DC_MC)){
...
static struct usb_device_id aicwf_usb_id_table[] = {
    ...
    {USB_DEVICE(USB_VENDOR_ID_AIC_USB, USB_PRODUCT_ID_AIC8800D83)},
    {USB_DEVICE(USB_VENDOR_ID_AIC_USB, USB_PRODUCT_ID_AIC8800D84)},
    {USB_DEVICE(USB_VENDOR_ID_AIC_USB, USB_PRODUCT_ID_AIC8800D85)},
    {USB_DEVICE(USB_VENDOR_ID_MERCUCYS, USB_PRODUCT_ID_AIC8800DC_MC)},
#endif
    {}
};
